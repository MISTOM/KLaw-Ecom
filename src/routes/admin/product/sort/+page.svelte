...
<div class="container mx-auto p-6">
	...
	<div class="mb-6">
		...
		<select
			...
			class="focus:border-primary focus:ring-primary/30 w-full max-w-xs rounded-lg border border-gray-200 bg-white px-4 py-2 focus:ring-5 focus:outline-hidden"
		>
